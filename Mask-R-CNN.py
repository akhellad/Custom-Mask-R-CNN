...
def train():
    ...
    model.train(dataset_train, dataset_val, learning_rate=config.LEARNING_RATE / 10, epochs=4, layers="all")
    end_train = time.time()
...
def inference():
    ...
    assert model_path != "", "Provide a valid model path"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train or run inference on Mask R-CNN model')
